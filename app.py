...
def regenerate_temsilcilik_html():
    ...
    <h3 style="color:#800000; font-weight:bold; margin-bottom:20px;">TÃ¼rkiye Temsilcilikleri</h3>
    ...
    <h3 style="color:#800000; font-weight:bold; margin-bottom:20px;">DÃ¼nya Temsilcilikleri</h3>
    ...
    if os.path.exists('hakkimizda.html'):
        ...
        if panels:
            ...
            if headings:
                ...
                headings[-1].string = 'Ä°dareci ve BÃ¼rokratlar BirliÄŸi / Temsilcilikler'
