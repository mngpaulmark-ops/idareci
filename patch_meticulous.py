...
# 6. Fix apply_menus_to_all_html
old_apply_menus = """def apply_menus_to_all_html():
    import glob
    import bs4
...
app_content = app_content.replace(old_apply_menus, new_apply_menus)

with open('app.py', 'w', encoding='utf-8') as f:
    f.write(app_content)
print("Finished patching app.py meticulously")
