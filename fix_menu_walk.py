...
# Find the start and end of apply_menus_to_all_html
start_idx = app_content.find("def apply_menus_to_all_html():")
if start_idx == -1:
    print("Function not found!")
    exit(1)

# Find the next function definition to know where to stop
...
with open('app.py', 'w', encoding='utf-8') as f:
    f.write(app_content)
print("Updated apply_menus_to_all_html successfully with os.walk")
